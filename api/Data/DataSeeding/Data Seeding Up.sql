...
IF not exists (select top 1 name from Properties where Name='Rental Apartment')
insert into Properties(SellRent,Name,PropertyTypeId,Bedrooms,FurnishingTypeId,Price,LandArea,Address1,
...
select 
1, -- 1) Sell Rent
'Rental Apartment', -- 2) Name
(select Id from PropertyTypes where Name='Apartment'), -- 3) Property Type ID
2, -- 4) Bedrooms
(select Id from FurnishingTypes where Name='Fully'), -- 5) Furnishing Type ID
1800, -- 6) Price
1400, -- 7) Land Area
'20 Sesame Street', -- 8) Address1
'Forest', -- 9) Address2
...
0, -- 15) Age
'Well Maintained apartment rent at prime location. # property features- - 5 mins away from metro station - Gated community - 24*7 security. # property includes- - Big rooms (Cross ventilation & proper sunlight) - 
Drawing and dining area - Washrooms - Balcony - Modular kitchen -', -- 16) Description
